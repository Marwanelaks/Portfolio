  ...
  return (
    <>
      <section className="bag">
        ...
        <section className=" back container-fuild me-6 ">
          <div className="row m-auto text-center">
            <div className="col-sm-6 frame-text07  m-auto text-center " >
    ...
    <img className="curv1" src="/playground_assets/dark2.png"></img>
      ...
      <div className="portf">
        ...
        <div className="row m-auto text-center ">
          ...
          <div className="col-sm-3 m-auto card carde">
      ...
      <div  className="about">
        <div className="container">
          ...
          <div className="row text-center m-auto">
            <div className="col-3 card text-center m-auto cards">
            ...
            <div className="col-3 card m-auto cards">
